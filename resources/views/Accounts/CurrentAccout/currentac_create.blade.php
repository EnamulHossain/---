            ...
            <div class="row">
                <div class="col-sm-12">
                    <h6 class="element-header text-center">
                        <form method="POST"
                            action="{{ route('current.account.store') }}" accept-charset="UTF-8" note="Are you agree for deposit desire amount?">
                            @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input type="text" name="target_amount" id="target_amount" class="form-control text-center" placeholder="Amount">
                                            </div>
                                        </div>
                                    </div>
                                </div>
