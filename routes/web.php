...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('general/account')->group(function () {
        ...
        Route::post('store', [GeneralAcController::class, 'store_general_account'])->name('general.account.store');
    ...
    Route::prefix('/current/account')->group(function () {
        ...
        Route::post('/store', [CurrentAccountController::class, 'current_account_store'])->name('current.account.store');
